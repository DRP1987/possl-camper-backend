...
class Settings(BaseSettings):
    ...
    # Paid Twilio / production WhatsApp template (optional but recommended for
    # business-initiated alerts outside the 24-hour customer service window).
    twilio_whatsapp_production_content_sid: str = ""
    twilio_whatsapp_production_content_variables: str = ""
